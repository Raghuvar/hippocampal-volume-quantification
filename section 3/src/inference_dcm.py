...
if __name__ == "__main__":
    ...
    inference_agent = UNetInferenceAgent(
        device="cpu",
        parameter_file_path=r"../trained_model/model.pth")
    ...
    report_save_path = r"../result/report.dcm"
    ...
    os_command("storescu localhost 4242 -v -aec HIPPOAI +r +sd ../result/report.dcm")
